...
class discovery_Welcome {
	...
	public function __construct() {
		...
		add_action( 'discovery_welcome', array( $this, 'discovery_welcome_tabs' ), 				20 );
		add_action( 'discovery_welcome', array( $this, 'discovery_welcome_getting_started' ), 	30 );
		add_action( 'discovery_welcome', array( $this, 'discovery_welcome_pro' ), 				40 );
		add_action( 'discovery_welcome', array( $this, 'discovery_welcome_who' ), 				60 );
